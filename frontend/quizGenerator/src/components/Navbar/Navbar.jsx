    ...
    <div className='bg-black md:bg-[#12151f] text-white py-4 px-6'>
      <div className='flex justify-between items-center'>
        ...
        <div className='hidden md:flex gap-6 items-center '>
          ...
          <button className='bg-gray-400 px-3 py-1 text-black rounded-lg font-bold'>Sign in</button>
          <button className='bg-gray-400 px-3 py-1 text-black rounded-lg font-bold'>Sign up</button>
        </div>
      ...
      {isOpen && (
        <div className='md:hidden mt-4 space-y-3'>
          ...
          <button className=' bg-gray-400 px-3 mr-3 py-2 text-black rounded-lg font-bold'>Sign in</button>
          <button className=' bg-gray-400 px-3 mx-3 py-2 text-black rounded-lg font-bold'>Sign up</button>
        </div>
      )}
    </div>
  );
